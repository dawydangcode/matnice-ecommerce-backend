...
export class CartLensDetailController {
  ...
  async createCartLensDetail(
    ...
    return await this.cartLensDetailService.createCartLensDetail(
      ...
      body.lensType,
      body.lensQuality,
      body.refractionIndex,
      body.upgradeHardCoating,
      body.upgradeAntiReflection,
      body.upgradeUvProtection,
      body.upgradeBlueLight,
      body.upgradeLotusEffect,
      body.upgradeSmartFocus,
      body.upgradeTransition,
      body.upgradeProgressive,
      body.upgradeHardCoatingPrice,
      body.upgradeAntiReflectionPrice,
      body.upgradeUvProtectionPrice,
      body.upgradeBluelightPrice,
      body.upgradeLotusEffectPrice,
      body.upgradeSmartFocusPrice,
      body.upgradeTransitionPrice,
      body.upgradeProgressivePrice,
      body.totalUpgradesPrice,
      body.lensPrice,
      body.lensMaterial,
      body.lensThickness,
      body.tintColor,
